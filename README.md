...
<p>を表示する</p>
<p>期限が迫っている予定一覧は、表示切替にカーソルを合わせると表示する予定の残り日数を1,5,10,30から選択できる</p>
<p>予定の調整ボタンを押すと推奨予定のタスク一覧に、期限が迫っている予定一覧の予定を選択すると、選択した予定のタスク一覧に遷移する</p>
...
<p>また、並び替えボタンを押すとダイアログが開くので、並び替えさせたい条件を選択し実行ボタンを押すと表示している予定一覧が並び替えされる</p>

![2021-11-15 (60)](https://user-images.githubusercontent.com/85385454/141776377-a9740c96-69c6-41c1-8fee-ecd4dff2d4b5.png)

<h2>タスク一覧画面の構成</h2>
<p>この画面ではホーム画面と同様に、選択した予定に結び付いているタスクの中で最も優先度の高いタスクを推奨タスクとして表示する</p>
<p>また、選択した予定に結び付いているタスクの達成数に応じて、進捗率をスライダーと％表記で表示する</p>
<p>それに加えて、現在の時間と期限の差をとり、予定の残り日数または残り時間を表示する</p>
...
<p>カレンダーアイコンのある部分を押すと年月を選択するダイアログが開くので、表示させたい達成済み予定の年月を選択する</p>
